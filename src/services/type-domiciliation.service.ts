...
export class TypeDomiciliationService {
  ...
  static async getAll(apiClient: ApiClient): Promise<TypeDomiciliationApiResponse> {
    const response = await apiClient.get<TypeDomiciliationApiResponse>(TypeDomiciliationService.BASE_URL);
    return response.data;
  }

  static async getByCode(apiClient: ApiClient, code: string): Promise<TypeDomiciliation> {
    const response = await apiClient.get<TypeDomiciliationApiResponse>(`${TypeDomiciliationService.BASE_URL}/${code}`);
  ...
  static async create(apiClient: ApiClient, type: TypeDomiciliationCreateRequest): Promise<TypeDomiciliationApiResponse> {
    const response = await apiClient.post<TypeDomiciliationApiResponse>(TypeDomiciliationService.BASE_URL, type);
    return response.data;
  }
  ...
  static async update(apiClient: ApiClient, code: string, type: TypeDomiciliationUpdateRequest): Promise<TypeDomiciliationApiResponse> {
    const response = await apiClient.put<TypeDomiciliationApiResponse>(`${TypeDomiciliationService.BASE_URL}/${code}`, type);
    return response.data;
  }

  static async delete(apiClient: ApiClient, code: string): Promise<TypeDomiciliationApiResponse> {
    const response = await apiClient.delete<TypeDomiciliationApiResponse>(`${TypeDomiciliationService.BASE_URL}/${code}`);
    return response.data;
  }

  static async search(apiClient: ApiClient, searchTerm: string): Promise<TypeDomiciliationApiResponse> {
    const response = await apiClient.get<TypeDomiciliationApiResponse>(`${TypeDomiciliationService.BASE_URL}/search`, {
